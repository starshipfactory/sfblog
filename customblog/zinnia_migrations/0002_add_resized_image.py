...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.resized_image'
        db.add_column(u'zinnia_entry', 'resized_image',
                      self.gf('imagetools.models.ThumbnailField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding index on 'Entry', fields ['status']
        db.create_index(u'zinnia_entry', ['status'])

        # Adding index on 'Entry', fields ['creation_date']
        db.create_index(u'zinnia_entry', ['creation_date'])

        # Adding index on 'Entry', fields ['end_publication']
        db.create_index(u'zinnia_entry', ['end_publication'])

        # Adding index on 'Entry', fields ['start_publication']
        db.create_index(u'zinnia_entry', ['start_publication'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Entry', fields ['start_publication']
        db.delete_index(u'zinnia_entry', ['start_publication'])

        # Removing index on 'Entry', fields ['end_publication']
        db.delete_index(u'zinnia_entry', ['end_publication'])

        # Removing index on 'Entry', fields ['creation_date']
        db.delete_index(u'zinnia_entry', ['creation_date'])

        # Removing index on 'Entry', fields ['status']
        db.delete_index(u'zinnia_entry', ['status'])

        # Deleting field 'Entry.resized_image'
        db.delete_column(u'zinnia_entry', 'resized_image')
    ...
    models = {
        ...
        'zinnia.entry': {
            ...
            'content_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['simplecms.Content']", 'unique': 'True'}),
            ...
            'resized_image': ('imagetools.models.ThumbnailField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
