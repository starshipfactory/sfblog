...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.page'
        db.add_column(u'events_location', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['simplecms.Page'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.page'
        db.delete_column(u'events_location', 'page_id')
    ...
    models = {
        ...
        u'simplecms.page': {
            ...
            '_full_path': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
